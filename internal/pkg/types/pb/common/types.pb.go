...
const file_common_types_proto_rawDesc = "" +
	"\n" +
	"\x12common/types.proto\x12\x06common\"5\n" +
	"\x05Error\x12\x12\n" +
	...
	"\aversion\x18\x02 \x01(\tR\aversionB%Z#yunyez/internal/pkg/types/pb/commonb\x06proto3"
...
var file_common_types_proto_goTypes = []any{
	...
	(*HealthRequest)(nil),  // 1: common.HealthRequest
	(*HealthResponse)(nil), // 2: common.HealthResponse
}
